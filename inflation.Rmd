...
labs(color = "") + theme(legend.position = c(.1, .9)) +
  NULL
...
```
# how to include a new chunk: option + command + i
...
usethis::use_git_config(
  user.name = "Beyza Sönmez", # <-- change to your name
  user.email = "bsoenmez@uni-bonn.de", # <-- and your email
